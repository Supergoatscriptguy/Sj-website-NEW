    ...
    <div className="relative">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-bold mb-6">
              <span className="gradient-text">SORCERER&apos;S JOURNEY</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-bold text-lg shadow-lg shadow-purple-500/50 hover:shadow-purple-500/80 transition-all"
              >
                Play Now
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 glass rounded-lg font-bold text-lg hover:bg-slate-800/50 transition-all"
              >
                Learn More
              </motion.a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-4">
              <span className="gradient-text">Epic Features</span>
            </h2>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-4">
              <span className="gradient-text">Featured Locations</span>
            </h2>
            <p className="text-xl text-slate-400">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-bold text-lg shadow-lg shadow-purple-500/50"
              >
                Play Free Now
              </motion.a>
              <motion.a
